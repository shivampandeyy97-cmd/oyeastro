  ...
  return (
    ...
    >
      ...
      <p className="text-textMuted text-sm text-center -mt-3">
        Real Swiss Ephemeris calculations · Lahiri Ayanamsa · Whole Sign houses
      </p>
      ...
      <form onSubmit={handleSubmit} className="w-full grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div className="flex flex-col gap-1.5">
          ...
          <div className="relative">
            <svg className="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 stroke-espresso fill-none stroke-2" viewBox="0 0 24 24">
        ...
        <div className="flex flex-col gap-1.5 relative">
          ...
          <div className="relative">
            <svg className="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 stroke-espresso fill-none stroke-2 z-10" viewBox="0 0 24 24">
          ...
          {showSuggestions && suggestions.length > 0 && (
            <ul className="absolute top-full left-0 right-0 mt-1 bg-white border-2 border-espresso rounded-neoSm shadow-neo z-50 overflow-hidden">
              {suggestions.map((s, i) => (
                <li
                  key={i}
                  className="px-4 py-2.5 text-sm cursor-pointer hover:bg-pastelOrange border-b border-espresso/10 last:border-0 truncate"
      ...
      <motion.button
        ...
        whileHover={{ y: -2, boxShadow: '6px 6px 0px #2c1905' }}
        whileTap={{ y: 2, boxShadow: '2px 2px 0px #2c1905' }}
